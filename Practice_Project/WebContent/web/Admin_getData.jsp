...
<script>
  /* function editData(idValue){
	   window.location.href = "EditData.jsp"+idValue ;
   }*/
</script>
<!-- //pie-chart --><!-- index page sales reviews visitors pie chart -->
            ...
            <ul class="sidebar-menu">
			  ...
			  <li class="treeview">
                ...
                <ul class="treeview-menu">
                  <li><a href="\Practice_Project/Admin_getData.jsp"><i class="fa fa-angle-right"></i> Total Users</a></li>
...
<table class="table table-hover" cellspacing = "4" cellpadding = "4">
  ...
  <% 
    ...
    <button type = "button" class = "btn btn-primary" onclick = "editData(<%=rs.getInt("id") %>)" >Edit</button>
    
      <a href = "DeleteData.jsp?d=<%=rs.getString("id") %>"><button type = "button" class = "btn btn-danger" >Delete</button></a>
        </td> 
    </tr>
    <%}%>
  </tbody>
